...
const MediumCard = ({ medium, onDelete, onUpdate }) => {
   ...
   const descansar = () => {
      API.descansarMedium(mediumData.id)
         .then(() => {
            ...
            <div className="card-bottomContainer">
               <div className="card-info medium-bottom">
                  ...
                  <div className="medium-buttonContainer">
                     ...
                     <button className="card-button" onClick={descansar}>Descansar</button>
                     {/* <button className="card-button">Mover</button> */}
                     {tieneAngeles && (
                        <button className="card-button" onClick={exorcizar}>Exorcizar</button>
                     )}
                  </div>
               </div>
            </div>
