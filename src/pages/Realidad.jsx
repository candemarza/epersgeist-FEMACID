...
const Realidad = () => {
   ...
   return (
      <div className="realidad-container">
         ...
         {realidad ? (
            <>
               <h1>Bifurcada por: {realidad.nombre}</h1>
                  ...
                  <div className="realidad-info">
                     {corrupcion ? (
                        <div className="realidad-corrupcion">
                           <h2>
                              Corrupcion total: {corrupcion.corrupcionActual}%
                           </h2>
